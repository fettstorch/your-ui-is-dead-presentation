...
<h1 v-if="$clicks >= 2" class="anim-in-fade transition-all duration-1000" :class="{'-translate-y-50': $clicks >= 3}"><Typewriter immediate :delay="1000">4. This would hurt performance!</Typewriter></h1>