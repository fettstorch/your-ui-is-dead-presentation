...
<div>
    <OnEnter>
        ...
        <div v-if="$clicks >= 1" class="speach-bubble absolute top-40 left-1/4 anim-in transition-all duration-1000" :class="{'-translate-x-38 translate-y-40': $clicks >= 2 }"><span v-html="t('perf.overview.bubble')" /> <div class="anim-float">PERFORMANCE!?!?</div></div>
    </OnEnter>
</div>
